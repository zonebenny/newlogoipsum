    ...
    <section className='bg-custom-darkgrey-color py-[50px] 2xl:py-[150px]'>
      <div className='container'>
        <div className='block md:flex justify-between mb-[60px] '>
          <h4 className='text-4xl 2xl:text-[50px] font-cormorantFont leading-[50px] text-custom-white font-normal mb-[25px] md:mb-0 threeD'>{pagedata?.ourblogsection?.title}</h4>
